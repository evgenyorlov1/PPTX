...
def openFile1(rows):
    ...
    heightTL = float(str(rows[20][1]).replace(' ', ''))
    heightTR = float(str(rows[22][1]).replace(' ', ''))
    heightBL = float(str(rows[24][1]).replace(' ', ''))
    heightBR = float(str(rows[26][1]).replace(' ', ''))


    #Rectangle 42
    F12 = tree.xpath('/p:sld/p:cSld/p:spTree/p:sp[27]/p:txBody/a:p/a:r[1]/a:t', namespaces={'a':'http://schemas.openxmlformats.org/drawingml/2006/main',
            'r':'http://schemas.openxmlformats.org/officeDocument/2006/relationships',
            'p':'http://schemas.openxmlformats.org/presentationml/2006/main'})
    ...
    TextBox46Y = tree.xpath('/p:sld/p:cSld/p:spTree/p:sp[27]/p:spPr/a:xfrm/a:off', namespaces={'a':'http://schemas.openxmlformats.org/drawingml/2006/main',
            'r':'http://schemas.openxmlformats.org/officeDocument/2006/relationships',
            'p':'http://schemas.openxmlformats.org/presentationml/2006/main'})
    TextBox46Y[0].attrib['y'] = unicode(upperButtomLine-round(leftRectangleStep*float((str(rows[19][1]).replace(' ', ''))[1:])) - 500000 -point*4)
    ...
    Rectangle42Y[0].attrib['y'] = unicode(upperButtomLine-round(leftRectangleHeight*heightTL)-point*2)
    Rectangle42CY[0].attrib['cy'] = unicode(round(leftRectangleHeight*heightTL));
    ...
    TextBox47X = tree.xpath('/p:sld/p:cSld/p:spTree/p:sp[28]/p:spPr/a:xfrm/a:off', namespaces={'a':'http://schemas.openxmlformats.org/drawingml/2006/main',
            'r':'http://schemas.openxmlformats.org/officeDocument/2006/relationships',
            'p':'http://schemas.openxmlformats.org/presentationml/2006/main'})
    TextBox47X[0].attrib['y'] = unicode(upperButtomLine-round(leftRectangleStep*float((str(rows[21][1][1:]).replace(' ', ''))[1:])) - 500000 -point*4)
    ...
    Rectangle43Y[0].attrib['y'] = unicode(upperButtomLine-round(leftRectangleHeight*heightTR)-point*2)
    Rectangle43CY[0].attrib['cy'] = unicode(round(leftRectangleHeight*heightTR));
    ...
    TextBox53X[0].attrib['y'] = unicode(lowerButtomLine-round(leftRectangleHeight*heightBL) - point*44)
    ...
    Rectangle50Y[0].attrib['y'] = unicode(lowerButtomLine-round(leftRectangleHeight*heightBL))
    Rectangle50CY[0].attrib['cy'] = unicode(round(leftRectangleHeight*heightBL));
    ...
    ee = float(ee)
    TextBox54X[0].attrib['y'] = unicode(lowerButtomLine-round(leftRectangleHeight*heightBR) - point*44)
    ...
    Rectangle51Y[0].attrib['y'] = unicode(lowerButtomLine-round(leftRectangleHeight*heightBR))
    Rectangle51CY[0].attrib['cy'] = unicode(round(leftRectangleHeight*heightBR));
    ...
    Rectangle63CYCX[0].attrib['cy'] = unicode(round(rightHeight*float(str(rows[53][1])))) #0.3 is variable
    Rectangle63CYCX[0].attrib['cx'] = unicode(round(rightWidth*var013)) #0.3 is variable
    ...
    Rectangle68YX[0].attrib['x'] = unicode(round(rightWidth*var013)+rightLeftCorner + 2*point);

    Rectangle68CYCX[0].attrib['cy'] = unicode(round(rightHeight*float(str(rows[54][1]))))
    Rectangle68CYCX[0].attrib['cx'] = unicode(round(maxwidth*var018))
    ...
    Rectangle69YX[0].attrib['x'] = unicode(round(rightWidth*(var013+var018) + 2*point +rightLeftCorner))

    Rectangle69CYCX[0].attrib['cy'] = unicode(round(rightHeight*float(str(rows[55][1]))))
    Rectangle69CYCX[0].attrib['cx'] = unicode(round(maxwidth*var048))
    ...
    Rectangle70YX[0].attrib['x'] = unicode(round(rightWidth*(var013+var018+var048) + 2*point +rightLeftCorner))

    Rectangle70CYCX[0].attrib['cy'] = unicode(round(rightHeight*float(str(rows[56][1]))))
    Rectangle70CYCX[0].attrib['cx'] = unicode(round(rightWidth-rightWidth*(var013+var018+var048)))
    ...
    xmlString = etree.tostring(tree, pretty_print=False)
    xmlStringClean = re.sub('\.0"', '"', xmlString)
    f.write('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>')
    f.write("\r\n");
    f.write(xmlStringClean)
    f.close()
...
def openFile3(rows):
    ...
    if(growth4 < 0):
        ...
        Picture61CYCX = tree.xpath('/p:sld/p:cSld/p:spTree/p:pic[8]/p:spPr/a:xfrm/a:ext', namespaces={'a':'http://schemas.openxmlformats.org/drawingml/2006/main',
            'r':'http://schemas.openxmlformats.org/officeDocument/2006/relationships',
            'p':'http://schemas.openxmlformats.org/presentationml/2006/main'})
        Picture61YX = tree.xpath('/p:sld/p:cSld/p:spTree/p:pic[8]/p:spPr/a:xfrm/a:off', namespaces={'a':'http://schemas.openxmlformats.org/drawingml/2006/main',
            'r':'http://schemas.openxmlformats.org/officeDocument/2006/relationships',
            'p':'http://schemas.openxmlformats.org/presentationml/2006/main'})
        #Picture61CYCX[0].attrib['cx'] = unicode('-100000')
        #Picture61CYCX[0].attrib['cy'] = unicode('-100000')
        Picture61CYCX[0].attrib['cx'] = unicode('0')
        Picture61CYCX[0].attrib['cy'] = unicode('0')
        #Picture61YX[0].attrib['x'] = unicode('-10000000')
        #Picture61YX[0].attrib['y'] = unicode('-10000000')
        Picture61YX[0].attrib['x'] = unicode('0')
        Picture61YX[0].attrib['y'] = unicode('0')
