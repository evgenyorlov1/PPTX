...
class Dashboard8(PPTXGenerator):

    sheet_name = 'Tax Dashboard'
    ...
    separate_charts = {
        'separate-headline-metrics': '8-Headline-Metrics.pptx',
        'separate-revenue-and-earnings': '8-Revenue-Earnings-by-Major-Service-Area.pptx',
        'separate-key-metrics': '8-Key-Metrics.pptx',
        'separate-eba-earnings': '8-EBA-Earnings.pptx',
        'separate-rates-and-cs-headcount': '8-Rates-CS-Headcount-by-Geo.pptx',
        'separate-top-10-managed-clients': '8-Top-10-Managed-Clients.pptx',
    }
    ...
    def fill_blue_rect(self):
        ...
        sizes = zip(
            'BCDEF',
            [self.get_cell(c) for c in C('B12', 'F12')],
            [self.get_cell(c) for c in C('B16', 'F16')],
        )
    ...
    def fill_values(self):
        super(Dashboard8, self).fill_values()
