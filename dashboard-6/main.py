...
class Dashboard6(PPTXGenerator):

    sheet_name = 'Audit Dashboard'
    ...
    separate_charts = {
        'separate-headline-metrics': '6-Headline-Metrics.pptx',
        'separate-revenue-and-earnings': '6-Revenue-Earnings-by-Major-Service-Area.pptx',
        'separate-key-metrics': '6-Key-Metrics.pptx',
        'separate-eba-earnings': '6-EBA-Earnings.pptx',
        'separate-rates-and-cs-headcount': '6-Rates-CS-Headcount-by-Geo.pptx',
        'separate-top-10-managed-clients': '6-Top-10-Managed-Clients.pptx',
    }
    ...
    def fill_top10(self):
        ...
        for r in range(49, 59):
            ...
            revenue_rect = self.get_element_by_title('revenue-%s' % r)
            margin_rect = self.get_element_by_title('margin-%s' % r)
    ...
    def fill_values(self):
        super(Dashboard6, self).fill_values()
